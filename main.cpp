...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "BitcoinTX-seeder\n"
...
static const string mainnet_seeds[] = {"45.55.92.248", "45.55.175.208", "45.55.179.167", ""};  
static const string testnet_seeds[] = {"45.55.92.248", "45.55.175.208", "45.55.179.167", ""}; 
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("45.55.92.248", 28280), true);
  }
  do {
